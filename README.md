...
| The agent starts coding from a one-line request; the PR needs rework and review drags.                                      | [`upfront-design`](./skills/upfront-design/SKILL.md) | Triages size, writes each approved design phase to a file outside the repo, records only hard-to-reverse decisions as ADRs, and checks landed milestones against the design. |
...
| A Todoist task depends on chat context, silently invents metadata, or duplicates existing work.                             | [`todoist-task`](./skills/todoist-task/SKILL.md)     | Resolves task metadata, requires missing identifiers, writes natural descriptions, checks duplicates, and verifies the saved task.                                         |
...
| ---------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [`prath-mode`](./skills/prath-mode/SKILL.md)         | Route one action or a complete workflow chain.                                                                 | Leaf owns its options                                                                                                                                                                                |
| [`upfront-design`](./skills/upfront-design/SKILL.md) | Agree product review, system design, program design, and vertical slices before code; check landed milestones. | Request text or an existing design path                                                                                                                                                              |
| [`peer-review`](./skills/peer-review/SKILL.md)       | Exhaustively review a plan or proposed change and issue a fixed verdict.                                       | Review target from the request                                                                                                                                                                       |
| [`verify`](./skills/verify/SKILL.md)                 | Fan out N isolated attempts, pairwise-verify, and select, or score current progress.                           | Default N `3`, evals `2`, pivots `2`, max-rounds `0`, auto criteria; track only when asked                                                                                                           |
| [`deslop`](./skills/deslop/SKILL.md)                 | Remove code slop from one git diff without changing behavior.                                                  | Default staged; unstaged or a named base branch from the request                                                                                                                                     |
| [`commit`](./skills/commit/SKILL.md)                 | Commit a locked snapshot with hunk-traced copy.                                                                | Default staged, conventional, hooks off, trailers denied                                                                                                                                             |
| [`make-pr`](./skills/make-pr/SKILL.md)               | Publish a branch and create or update its PR with a diff-scaled body and rich proved visuals on every tier.    | Default target `main`, no ticket, default title                                                                                                                                                      |
| [`fix-pr`](./skills/fix-pr/SKILL.md)                 | Resolve open PR feedback and CI, then reply with evidence.                                                     | Default current-branch PR, push, and reply                                                                                                                                                           |
| [`gh`](./skills/gh/SKILL.md)                         | Orient on PR state, review threads, or CI, or post one reply.                                                  | Default current-branch PR, cwd repo, truncated text; emit `scripts/run` argv after derivation                                                                                                        |
| [`explain-diff`](./skills/explain-diff/SKILL.md)     | Write an HTML teaching page for a diff, branch, or PR.                                                         | Default `main...HEAD`; staged, unstaged, PR, or output path from the request                                                                                                                         |
| [`recon`](./skills/recon/SKILL.md)                   | Build or refresh a persistent map of the current repo.                                                         | Default warm patch when memory exists; rebuild or a named focus from the request                                                                                                                     |
| [`box`](./skills/box/SKILL.md)                       | Clone, update, list, search, or persist an external repo.                                                      | Default clone-if-needed then search; persist, update, list, or direct mode when asked                                                                                                                |
| [`todoist-task`](./skills/todoist-task/SKILL.md)     | Create or preview specific, naturally written Todoist tasks from conversational requests.                     | Default Inbox, no due date, `p4`, no parent                                                                                                                                                          |
| [`handoff`](./skills/handoff/SKILL.md)               | Save or resume bounded session state.                                                                          | Default create at the timestamped anchor path; resume path or live focus from the request                                                                                                            |
| [`orchestrate`](./skills/orchestrate/SKILL.md)       | Coordinate in-harness subagents as a read-only parent.                                                         | Task from the request                                                                                                                                                                                |
| [`cursor-agent`](./skills/cursor-agent/SKILL.md)     | Drive the Cursor Agent CLI for one-shot and related runs.                                                      | Default `--print`, omit mode, text, 15m wait; emit CLI argv after derivation                                                                                                                         |
| [`claude-code`](./skills/claude-code/SKILL.md)       | Drive the Claude Code CLI for one-shot and related runs.                                                       | Default `--print`, text, 15m wait; emit CLI argv after derivation                                                                                                                                    |
| [`codex`](./skills/codex/SKILL.md)                   | Drive the Codex CLI for one-shot exec and related runs.                                                        | Default `codex exec -C`, omit sandbox, 15m wait; emit CLI argv after derivation                                                                                                                      |
