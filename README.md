...
| [`upfront-design`](./skills/upfront-design/SKILL.md) | Agree product review, system design, program design, and vertical slices before code; check landed milestones. | positional request or design path                                                                                                                                                                    |
...
| [`todoist-task`](./skills/todoist-task/SKILL.md)     | Create or preview specific, naturally written Todoist tasks from conversational requests.                     | None                                                                                                                                                                                                 |
