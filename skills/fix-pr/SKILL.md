...
root is present. When using GitHub CLI, load the hunt recipes in
`./REFERENCE.md`. Record counts and final page markers. Do not triage or edit
before all six passes finish.
...
If reproduction is skipped, record why. No edits until every finding has a
verdict.
