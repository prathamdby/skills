...
Sourced from [Cursor plugins `unslop`](https://github.com/cursor/plugins/tree/main/pstack/skills/unslop). Apply to every PR thread reply draft before posting.
...
26. **Abstract metaphor nouns.** Substrate, wedge, vector, locus, vantage, nexus, primitive (as noun), harness (as metaphor), surface (as in "API surface"), bedrock, scaffolding (as metaphor), modality, paradigm, gold-plating. Pick the plainer concrete word.

### Plain speech

27. **Say the concrete thing.** Name the mechanism, instruction, fact, or number. If you can't, cut it.
28. **Shorten or split dense sentences.** One idea per sentence.
29. **Active voice.** Name the actor unless unknown or irrelevant.
